...
function ready() {
    ...
    $.ajax({
        ...
        map = new google.maps.Map(mapCanvas, mapOptions);
            ...
            var contentString ="<div class='content'style='text:centered'><h4>"+elements[0].name
            +"</h4><p>"+elements[0].address+"<br>"+elements[0].city+"<br>Phone:"+elements[0].phone+"<br>"+elements[0].email+"</p></div>"
