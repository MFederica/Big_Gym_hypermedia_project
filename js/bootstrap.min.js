...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (a) {
    ...
    b.DEFAULTS = {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                var f = function (b) {
                    return b && b.target != this.$element[0] ? void this.$element.one(a.support.transition.end, a.proxy(f, this)) : (this.$element.removeClass("collapsing").addClass("collapse in")[e](""), this.transitioning = 0, void this.$element.off(a.support.transition.end + ".bs.collapse").trigger("shown.bs.collapse"))
                };
                if (!a.support.transition) return f.call(this);
                var g = a.camelCase(["scroll", e].join("-"));
                this.$element.on(a.support.transition.end + ".bs.collapse", a.proxy(f, this)).emulateTransitionEnd(350)[e](this.$element[0][g])
            }
        }
    ...
    function b(b) {
        b && 3 === b.which || (a(d).remove(), a(e).each(function () {
            var d = c(a(this)),
                e = {
                    relatedTarget: this
                };
